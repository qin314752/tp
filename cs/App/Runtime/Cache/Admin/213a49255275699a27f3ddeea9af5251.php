				...
				<span class="l">
				    ...
				    <select style="width:100px;" name="prod_kind" autocomplete="off">
							<option value="">---请选择---</option>
		 					...
		 					<option value="2" <?php echo ($kind['prod_kind']==2?selected:''); ?>>足浴</option>
		 					<option value="3" <?php echo ($kind['prod_kind']==3?selected:''); ?>>推拿</option>
		 					<option value="4" <?php echo ($kind['prod_kind']==4?selected:''); ?>>spa养生</option>
		 					<option value="5" <?php echo ($kind['prod_kind']==5?selected:''); ?>>中医调理</option>
