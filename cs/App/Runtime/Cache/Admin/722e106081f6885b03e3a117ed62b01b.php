	...
	<div class="Hui-article">
		<div class="page-container">
			...
			<div class="cl pd-5 bg-1 bk-gray mt-0">
					<form action="/index.php/admin/Global/refund_list" method="post">
				<span class="l">
		<span style="color: #3B5999;font-size: 15px;">管理员操作日志</span>

				</span>
				</form>
				<span class="r" style="margin-right: 40px">
					<strong>
						<?php echo ($adminlog_num); ?>
					</strong>
				 </span>
			</div>
			<table class="table table-border table-bordered table-bg">
				...
				<tbody>
				<?php if(is_array($admin_log)): $k = 0; $__LIST__ = $admin_log;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tab): $mod = ($k % 2 );++$k;?><tr class="text-c">
