...
<?php if(empty($product)){echo '<div class="product_more"><img src="/Public/Home/img/no_data.jpg"></div>';?>
...
<?php  foreach ($product as $key => $value) {?>
	<div class="list"  onclick="javascript:location.href='/index.php/Home/Index/particulars?id=<?php echo $value['id'];?>&prod_brand=<?php echo $value['prod_brand']?>&home_img=<?php echo $home_img;?>' " >
			<?php if($key<=2){?>
			<div class="product_grade"><img  src="/Public/Home/img/no<?php echo $key+1;?>.png"></div>
			<?php }?>
