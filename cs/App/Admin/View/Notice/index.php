...
<section class="Hui-article-box">
	...
	<div class="Hui-article">
		<article class="cl pd-20">
			<form action="__URL__/index" method="post" class="form form-horizontal" id="form-article-add">
				<div id="tab-system" class="HuiTab">
					<div class="tabBar cl"><span>短信设置</span>
						<!-- <span>邮件设置</span> -->
					</div>
				<!-- 	<div class="tabCon">
						<div class="row cl">
					...
					<div class="tabCon">
						...
						<div class="row cl">
							<label class="form-label col-xs-3 col-sm-2">发件人昵称：</label>
							<div class="formControls col-xs-8 col-sm-3">
								<input name="smtp_name"  type="text"  value="{$note['smtp_name']}" class="input-text">
							</div>
						</div>
						<div class="row cl">
							<label class="form-label col-xs-3 col-sm-2">邮件标题：</label>
							<div class="formControls col-xs-8 col-sm-3">
								<input name="smtp_title"  type="text"  value="{$note['smtp_title']}" class="input-text">
							</div>
						</div>
