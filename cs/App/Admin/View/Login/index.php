...
<!-- <link href="__PUBLIC__/Admin/static/h-ui/css/H-ui.login.css" rel="stylesheet" type="text/css" /> -->
...
<link href="__PUBLIC__/Admin/admin.css" rel="stylesheet" type="text/css" />
...
<div class="loginWraper" >
	<div id="loginform" class="loginBox">
		<form class="form form-horizontal" action="__URL__/login" method="post">
