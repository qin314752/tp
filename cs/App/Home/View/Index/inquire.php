...
<?php if(empty($product)){echo '<div class="product_more"><img src="__PUBLIC__/Home/img/no_data.jpg"></div>';?>
<include file="Common:foot" />
<?php }else{?>

<div class="product_banne"><img src="/<?php echo $carousel;?>"></div>
...
<?php  foreach ($product as $key => $value) {?>
	<div class="list"  onclick="javascript:location.href='__URL__/particulars?id=<?php echo $value['id'];?>&prod_brand=<?php echo $value['prod_brand']?>&home_img=<?php echo $home_img;?>' " >
			<?php if($key<=2){?>
			<div class="product_grade"><img  src="__PUBLIC__/Home/img/no<?php echo $key+1;?>.png"></div>
			<?php }?>
			<div class='product_list'>
				...
				<div class="product_left">
					...
					<div class="product_left_kind"><?php echo $value['prod_kind']!=1?$value['prod_product_time']:'';?>分钟 &nbsp;&nbsp;|&nbsp;&nbsp;<?php echo prod_kind($value['prod_kind'])?> </div>
