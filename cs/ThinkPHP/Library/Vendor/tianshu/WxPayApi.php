...
class WxPayApi
{
	...
	public static function notify($callback, &$msg)
	{
		...
		$xmls = file_get_contents('php://input', 'r');
		$xmlss = file_get_contents('php://input');
		file_put_contents('/Public/cc.text', $xml);
		file_put_contents('/Public/ccc.text', $xmls);
		file_put_contents('/Public/cccc.text', $xmlss);
		//如果返回成功则验证签名
		try {
